...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'MMLB SOLUTIONS');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@mmlb.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
